...
const data = {
  "explosive-finger": {
    ...
    tech: ["Unity", "C#", "Git"],
    actions: "What I did in this game? Pretty much everything. I set up the touch logic for how the projectile is shot, made all the systems that govern the game. The most interesting part of this game was getting the touch logic to work, because it sort of works like a sling shot, so figuring that part out was fun and it was a new mechanic that I wasn't familiar with.",
  ...
  "khamani": {
    ...
    tech: ["Unity", "C#", "Git"],
    actions: "What I did: <br>- So this was the first game where I created a character controller using the state machine architecture and I combined that with the animation system in Unity to bring the character to life. <br>- I worked on creating a power up system with different progressions through rarities.<br>- Used an extensive event bus system to drive different actions and  logic flows of the game.<br>- Created enemy AI logic using the same state machine architecture.<br>- Used optimization techniques to help the game run at smoother frame rates.",
  ...
  "wacky-deliveries": {
    ...
    tech: ["Unity", "C#", "Git"],
    actions: "What I did: I did almost everything, but the big thing to take away is that, I worked on a car controller, it was my first attempt. I experimented  with wheel colliders in different configurations along with different physics materials to create an experience that fit the design of the game.",
  ...
  "fatpack-joe": {
    ...
    actions: "I implemented the entire codebase for the game. I created the core mechanics, the jetpack, created the power-up system, the in game shop, created the level spawning system, the score, the enemy AI, everything gameplay wise. I added the game through Play Store, implemented rewarded ads and interstial ads using Iron Source's API, I integrated the Google Play games API into the game to implement a leader board in the game.",
